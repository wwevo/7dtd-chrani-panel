...
$file = file_get_contents('http://api.chrani-bot.notjustfor.me:8082/api/getlandclaims?adminuser=' . constant("SDTD-ADMINUSER") . '&admintoken=' . constant("SDTD-ADMINTOKEN"), false, $context);
echo $file;
